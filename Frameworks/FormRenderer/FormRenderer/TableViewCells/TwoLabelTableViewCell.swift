...
//  Form
//
//  Created by Arun Eswaramurthi on 10/11/20.
...
class TwoLabelTableViewCell: UITableViewCell {
	...
	private var model: TwoTextDisplayModel?
	
	func configure(_ model: TwoTextDisplayModel) {
		leftLabel.text = model.leftText
		rightLabel.text = model.rightText
		
		leftLabel.textAlignment = model.leftAlignment
		rightLabel.textAlignment = model.rightAlignment
